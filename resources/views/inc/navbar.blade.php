<header>
    <div class="container">
        ...
        <div class="logo"><a href="index-2.html" title=""><img src="img/logo.png" alt=""
                srcset="img/01_Logo_2x.png 2x"></a></div>
        <!--logo end-->
        <ul class="contact-add d-flex flex-wrap">
            <li>
            <div class="contact-info"><img src="img/icon1.png" alt="">
            ...
            <li>
            <div class="contact-info"><img src="img/icon2.png" alt="">
                <div class="contact-tt">
            ...
            <li>
            <div class="contact-info"><img src="img/icon3.png" alt="">
                <div class="contact-tt">
        ...
        <nav>
            <ul>
            <li><a class="active" href="index-2.html" title="">Home</a></li>
